...
| Roll | Modell | Uppgift |
|------|--------|--------|
| **Implementation** | Cursor auto | Implementera en fas i worktree; bara den fasen (läs PLAN.md). |
| **Verifiering** | Cursor auto | Kontrollera att fasen uppfyller VERIFICATION.md för den fasen + build. |
