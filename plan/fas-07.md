...
- [x] Bygga inställningssida med sektioner
- [x] Företagsuppgifter: namn, organisationsnummer, adress
- [x] Server Action `updateTenant` med admin-check
- [x] Lista alla användare i tenant med roll
- [x] Ändra roll på befintlig användare
- [x] Ta bort användare (avsluta membership)
- [x] Visa inbjudningar (aktiva, väntande, utgångna)
