...
import { Hammer, LayoutDashboard, User, FolderOpen, Clock3, Settings, PanelLeftClose, PanelLeft, Zap, Mail, Package, ClipboardList, FileText } from "lucide-react"
...
const navItems = [
  ...
  { href: "/quotes", icon: FileText, labelKey: "quotes" as const },
] as const
