...
export function NoteCardMarkdown({ content }: NoteCardMarkdownProps) {
  ...
  return (
    <div className="pointer-events-none line-clamp-4 text-sm text-muted-foreground">
      <div className="prose prose-sm dark:prose-invert max-w-none prose-headings:text-sm prose-headings:font-medium prose-headings:text-muted-foreground prose-p:my-0.5 prose-p:text-muted-foreground prose-strong:text-muted-foreground prose-ul:my-0.5 prose-ol:my-0.5 prose-li:my-0 prose-li:text-muted-foreground prose-code:text-xs prose-code:bg-muted prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:before:content-none prose-code:after:content-none prose-pre:hidden prose-img:hidden prose-a:text-muted-foreground prose-a:no-underline">
        <ReactMarkdown
